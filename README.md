...
Соединим 15 версию, и 21 для множества картинок.

[LZW image generator on Babylon.js(Version 22 - More images LZW RGB Lents but no space just dict of constituent elements) | Babylon.js Playground](https://playground.babylonjs.com/#VPZO5F)

Нужно создать биомы картинок ввиде колонок по XZ подиумов.

[LZW image generator on Babylon.js (Version 23 - More images LZW but no spaces just dict: Bioms XZ podium) | Babylon.js Playground](https://playground.babylonjs.com/#7TSSY5#2)
...
[LZW image generator on Babylon.js(Version 29-More image LZW but no space just dict an image cut into 4 pieces crosswise) | Babylon.js Playground](https://playground.babylonjs.com/#UY6CTB#1)
